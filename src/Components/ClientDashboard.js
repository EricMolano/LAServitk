...
const Header = () => {
    ...
    const handlePerfilClick = () => {
        ...
        navigate('/Profile'); // Cambia la ruta según sea necesario
    };
    
    const handleVehiculosClick = () => {
        console.log("Vehículos clickeado");
        navigate('/Vehicles'); // Cambia la ruta según sea necesario
    };
    ...
    <div className='nav-container-1as'>
        ...
        <div className='logout-container-1as'>
            ...
            <section className="textos-header hidden">
                <h1>Bienvenido</h1>
                <h2>Con La Servitk puedes arreglar tu vehículo</h2>
            </section>
